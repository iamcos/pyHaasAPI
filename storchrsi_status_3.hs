{
  ...
  "Data": {
    ...
    "CR": {
      ...
      "CR": [],
      "CL": [
        "1773169529 ||| 0 ||| Compiling script...",
        "1773169529 ||| 0 ||| TIP: Using OptimizedForInterval() in combination with the technical analysis commands will improve the backtest speed.",
        "1773169529 ||| 3 ||| ERROR: Missing DefineOutput() definition."
      ],
      "LCE": [],
      "VCE": [],
      "I": [],
