...
from pyHaasAPI_v1.api import RequestsExecutor, get_all_accounts, rename_account
from pyHaasAPI_v1.accounts import AccountNamingManager
...
class AccountCleanupTool:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            from pyHaasAPI_v1.api import Guest
