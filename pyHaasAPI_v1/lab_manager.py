...
from pyHaasAPI_v1.model import CreateLabRequest, StartLabExecutionRequest, CloudMarket
from pyHaasAPI_v1.parameter_handler import ParameterHandler
from pyHaasAPI_v1.parameters import LabSettings as ParametersLabSettings
from pyHaasAPI_v1.tools.utils import BacktestFetcher, BacktestFetchConfig
...
class LabManager:
    ...
    def create_optimized_lab(self, 
        ...
        try:
            from pyHaasAPI_v1.lab import update_lab_parameter_ranges
