{
  ...
  "Data": {
    ...
    "CR": {
      ...
      "CR": [],
      "CL": [
        "1773168925 ||| 0 ||| Compiling script...",
        "1773168925 ||| 0 ||| TIP: Using OptimizedForInterval() in combination with the technical analysis commands will improve the backtest speed.",
        "1773168925 ||| 3 ||| ERROR:  - TableType",
        "1773168925 ||| 3 ||| ERROR: Unknown references:"
      ],
      "LCE": [],
      "VCE": [],
      "I": [],
