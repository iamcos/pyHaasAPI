"""
Comprehensive unit tests for Pydantic models with correct field usage.
"""
...
class TestLabSettings:
    ...
    def test_lab_settings_creation_with_field_names(self):
        """Test LabSettings creation using field names."""
        settings = LabSettings(
...
class TestLabParameter:
    ...
    def test_lab_parameter_creation_with_field_names(self):
        """Test LabParameter creation using field names."""
        param = LabParameter(
            key="test_param",
            value=10.5,
            param_type=1,
    ...
    def test_lab_parameter_validation_errors(self):
        ...
        with pytest.raises(ValueError):
            LabParameter(
                key="test_param",
                value=10.5,
                param_type=5  # Invalid type
            )


class TestLabRecord:
    """Test LabRecord model."""
    ...
    def test_lab_record_creation_with_field_names(self):
        """Test LabRecord creation using field names."""
        record = LabRecord(
            lab_id="lab123",
            name="Test Lab",
            script_id="script456",
...
class TestBotDetails:
    ...
    def test_bot_details_creation(self):
        ...
        bot = BotDetails(
            ...
            scriptId="script456",  # Using alias
            scriptName="Test Script",  # Using alias
            scriptVersion="1.0.0",  # Using alias
            accountId="account789",  # Using alias
            marketTag="BTC_USDT",  # Using alias
        ...
        assert bot.script_version == "1.0.0"
...
class TestApiResponse:
    ...
    def test_api_response_creation_with_field_names(self):
        """Test ApiResponse creation using field names."""
        response = ApiResponse(
            success=True,
            error="",
            data={"test": "value"}
...
class TestPaginatedResponse:
    ...
    def test_paginated_response_creation_with_field_names(self):
        """Test PaginatedResponse creation using field names."""
        response = PaginatedResponse(
            items=[{"id": 1}, {"id": 2}],
            total_count=100,
            page=1,
...
class TestErrorResponse:
    ...
    def test_error_response_creation_with_field_names(self):
        """Test ErrorResponse creation using field names."""
        error = ErrorResponse(
            error_code=400,
