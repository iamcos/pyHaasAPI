...
class FixedLongestBacktest:
    ...
    def update_lab_name_with_date(self, lab_id: str, start_unix: int) -> bool:
        ...
        try:
            ...
            # Add new date in DD.MM.YYYY format
    ...
    def start_backtest(self, lab_id: str) -> str:
        ...
        try:
            ...
            print(f"🔧 Preserving lab config: MP={original_config['max_population']}, MG={original_config['max_generations']}")
            
            start_request = model.StartLabExecutionRequest(
                lab_id=lab_id,
                startunix=lab_details.start_unix,
                endunix=lab_details.end_unix,
    ...
    def test_period(self, lab_id: str, start_unix: int, end_unix: int, period_name: str) -> bool:
        ...
        try:
            ...
            # Start backtest
            job_id = self.start_backtest(lab_id)
    ...
    def run_fixed_longest_backtest(self, lab_ids: list, dry_run: bool = False) -> dict:
...
def main():
    ...
    results = fixed_backtest.run_fixed_longest_backtest(lab_ids, dry_run=args.dry_run)
