{
  ...
  "Data": {
    ...
    "CR": {
      ...
      "CR": [],
      "CL": [
        "1762242663 ||| 0 ||| Compiling script...",
        "1762242663 ||| 2 ||| WARNING: This script can not be used for trading. No trading command detected.",
        "1762242663 ||| 3 ||| ERROR: SCRIPT ERROR: 'chunk_1:(1,0-1): unexpected symbol near '/'' at [1:0-1]"
      ],
      "LCE": [
        {
          "ErrorMessage": "'chunk_1:(1,0-1): unexpected symbol near '/'' at[1:0-1]",
          "FromLine": 1,
          "ToLine": 1,
          "FromColumn": 0,
          "ToColumn": 1
